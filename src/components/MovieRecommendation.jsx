...
const MovieRecommendation = () => {
  ...
  const fetchSimilarMovies = async (movieData) => {
    ...
    try {
          ...
          messages: [
            {
              role: "system",
              content:
                "Du bist ein hilfreicher Assistent, der ALLE Filme weltweit kennt und gute Empfehlungen ausspielen kann. Du generierst an Hand von Filmdaten ähnliche Filme. Deine Antwort MUSS in JSON Format kommen und soll ein Javascript-Array OHNE key sein, bei welchem JEDER Film/Eintrag ein weiteres JSON-Objekt sein soll mit Daten wit 'Title' usw. - Ich will nur 'Year', 'Title' haben.",
            },
      ...
      const similarMoviesObject = JSON.parse(
